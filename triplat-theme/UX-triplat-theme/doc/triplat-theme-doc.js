...
import "./triplat-theme-doc-data.js";
		...
		<div class="container">
			...
			<div class="group">
				...
				<div class="elements-container">
					...
					<paper-button class="element-item" noink="" primary-outline="">primary-outline</paper-button>
				...
				<div class="elements-container">
					...
					<paper-button class="element-item" disabled="" noink="" primary-outline="">primary-outline</paper-button>
    ...
    ready: function() {
		...
		TriplatThemeDocData.forEach(function(group) {
			group.vars.forEach(function(cssVar) {
				styleString += "div {background-color:var(" + cssVar.name + ");}";
			});
		});
		var styleElement = document.createElement("style", "custom-style");
		styleElement.innerHTML = styleString;
		dom(this.root).appendChild(styleElement);

		this.async(function() {
			var styleProperties = dom(this.root).querySelector("style")._styleProperties;

			TriplatThemeDocData.forEach(function(group) {
				group.vars.forEach(function(cssVar) {
					cssVar.value = Polymer.StyleProperties.valueForProperty("var(" + cssVar.name + ")", styleProperties);
				});
			});
